...
SECRET_KEY = 'django-insecure-(1nhy%0e__$3(=03p#kt!35kxh9d7g8e#bi(7ek6lz)udqhg_q'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'crmapp',          # Replace with your database name
        'USER': 'root',              # Replace with your database user
        'PASSWORD': 'some',          # Replace with your database password
